...
mongoose.connect(`mongodb+srv://${process.env.mongoId}:${process.env.mongoPass}@cluster0.rzhgq.mongodb.net/Database1?retryWrites=true&w=majority`, {useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true})
.then(() => {
